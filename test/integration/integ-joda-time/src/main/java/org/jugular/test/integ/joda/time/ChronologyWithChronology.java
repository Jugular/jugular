 ...
 */
@Service
public class ChronologyWithChronology {

    private final Chronology constructor;
    @Jugular
    @Joda(chronology = Joda.Type.ETHIOPIC)
    private Chronology field;

    @Jugular
    ChronologyWithChronology(
            @Joda(chronology = Joda.Type.ETHIOPIC) Chronology chronology) {
