 ...
 */
@HK2
public class DateTimeWithNothingTest {

    @Inject
    DateTimeWithNothing service;
    @Inject
    ...
    public void assertConstructorInjection() {
        ...
        assertThat(dateTime.getZone()).isEqualTo(controller.getDateTimeZone());
        assertThat(dateTime.getChronology()).isEqualTo(controller.getChronology());
    }
